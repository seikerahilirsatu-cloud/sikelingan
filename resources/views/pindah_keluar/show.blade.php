...
<div class="max-w-3xl mx-auto">
  <div class="mb-4">
    ...
    @endif
    <h1 class="text-2xl font-semibold page-title">Detail Pindah Keluar</h1>
  </div>
  ...
  <div class="bg-white rounded-2xl shadow p-4">
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
      ...
      <div><div class="text-gray-600">Tanggal Pindah</div><div class="font-medium">{{ optional($item->tanggal_pindah)->format('Y-m-d') }}</div></div>
      <div><div class="text-gray-600">Jenis Pindah</div><div class="font-medium">@db($item->jenis_pindah)</div></div>
      <div class="sm:col-span-2"><div class="text-gray-600">Tujuan</div><div class="font-medium">@db($item->tujuan)</div></div>
