        ...
        @foreach($residents as $r)
            <article class="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition">
                <div class="flex items-start justify-between">
                    <div>
                        <div class="text-sm text-gray-500">NIK: <span class="font-medium">{{ $r->nik }}</span></div>
                        <a href="{{ route('biodata_warga.show', $r) }}" class="block mt-1 text-lg font-semibold text-gray-800">{{ $r->nama_lgkp }}</a>
