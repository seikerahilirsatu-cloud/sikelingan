...
<div class="max-w-3xl mx-auto">
  ...
  <div class="bg-white rounded-2xl shadow p-4">
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
      ...
      <div><div class="text-gray-600">Tanggal Masuk</div><div class="font-medium">{{ optional($item->tanggal_masuk)->format('Y-m-d') }}</div></div>
      <div><div class="text-gray-600">Jenis Masuk</div><div class="font-medium">@db($item->jenis_masuk)</div></div>
      <div class="sm:col-span-2"><div class="text-gray-600">Asal</div><div class="font-medium">@db($item->asal)</div></div>
    ...
    <div class="mt-4">
      <a href="{{ route('pindah_masuk.edit', $item) }}" class="inline-flex items-center px-3 py-1 bg-yellow-500 text-white rounded-md text-sm">Edit</a>
    </div>
  </div>
</div>
@endsection
