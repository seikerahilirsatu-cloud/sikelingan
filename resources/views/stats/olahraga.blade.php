...
@section('content')
<div class="space-y-4" id="stat-olahraga">
  <header class="flex items-center gap-3">
    ...
    <div>
      <div class="text-lg font-semibold">Statistik Sarana Olahraga</div>
  ...
  <section class="bg-white rounded-2xl shadow p-6">
    <div class="flex flex-col items-center text-center gap-3">
      ...
      <div class="text-sm text-gray-600">Konten statistik sarana olahraga sedang disiapkan.</div>
    </div>
  </section>
</div>
@endsection
